...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000828u)
...
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800083Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT4_AG, 0xC1u);
