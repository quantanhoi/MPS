...
{
    uint8 staticBits = (Pin_Buzz_DR & (uint8)(~Pin_Buzz_MASK));
    Pin_Buzz_DR = staticBits | ((uint8)(value << Pin_Buzz_SHIFT) & Pin_Buzz_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_Buzz_0, mode);
}
...
{
    return (Pin_Buzz_PS & Pin_Buzz_MASK) >> Pin_Buzz_SHIFT;
}
...
{
    return (Pin_Buzz_DR & Pin_Buzz_MASK) >> Pin_Buzz_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Pin_Buzz_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Pin_Buzz_0_INTR) != 0u) 
		{ 
			 Pin_Buzz_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_Buzz_INTSTAT & Pin_Buzz_MASK) >> Pin_Buzz_SHIFT;
    }
