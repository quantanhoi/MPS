...
#define Timer_TimerUDB_sT16_timerdp_u0__MSK_DP_AUX_CTL_REG CYREG_B1_UDB08_MSK_ACTL
#define Timer_TimerUDB_sT16_timerdp_u0__PER_DP_AUX_CTL_REG CYREG_B1_UDB08_MSK_ACTL
...
/* SysClk */
#define SysClk__CFG0 CYREG_CLKDIST_DCFG0_CFG0
#define SysClk__CFG1 CYREG_CLKDIST_DCFG0_CFG1
#define SysClk__CFG2 CYREG_CLKDIST_DCFG0_CFG2
#define SysClk__CFG2_SRC_SEL_MASK 0x07u
#define SysClk__INDEX 0x00u
#define SysClk__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define SysClk__PM_ACT_MSK 0x01u
#define SysClk__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define SysClk__PM_STBY_MSK 0x01u

/* Out_Ena */
#define Out_Ena_Sync_ctrl_reg__0__MASK 0x01u
#define Out_Ena_Sync_ctrl_reg__0__POS 0
#define Out_Ena_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB12_13_ACTL
#define Out_Ena_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB12_13_CTL
#define Out_Ena_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB12_13_CTL
#define Out_Ena_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB12_13_CTL
#define Out_Ena_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB12_13_CTL
#define Out_Ena_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB12_13_MSK
#define Out_Ena_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB12_13_MSK
#define Out_Ena_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB12_13_MSK
#define Out_Ena_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB12_13_MSK
#define Out_Ena_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB12_ACTL
#define Out_Ena_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB12_CTL
#define Out_Ena_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB12_ST_CTL
#define Out_Ena_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB12_CTL
#define Out_Ena_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB12_ST_CTL
#define Out_Ena_Sync_ctrl_reg__MASK 0x01u
#define Out_Ena_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB12_MSK_ACTL
#define Out_Ena_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB12_MSK_ACTL
#define Out_Ena_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB12_MSK

/* Pin_Buzz */
#define Pin_Buzz__0__INTTYPE CYREG_PICU0_INTTYPE6
#define Pin_Buzz__0__MASK 0x40u
#define Pin_Buzz__0__PC CYREG_PRT0_PC6
#define Pin_Buzz__0__PORT 0u
#define Pin_Buzz__0__SHIFT 6u
#define Pin_Buzz__AG CYREG_PRT0_AG
#define Pin_Buzz__AMUX CYREG_PRT0_AMUX
#define Pin_Buzz__BIE CYREG_PRT0_BIE
#define Pin_Buzz__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_Buzz__BYP CYREG_PRT0_BYP
#define Pin_Buzz__CTL CYREG_PRT0_CTL
#define Pin_Buzz__DM0 CYREG_PRT0_DM0
#define Pin_Buzz__DM1 CYREG_PRT0_DM1
#define Pin_Buzz__DM2 CYREG_PRT0_DM2
#define Pin_Buzz__DR CYREG_PRT0_DR
#define Pin_Buzz__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_Buzz__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_Buzz__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_Buzz__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_Buzz__MASK 0x40u
#define Pin_Buzz__PORT 0u
#define Pin_Buzz__PRT CYREG_PRT0_PRT
#define Pin_Buzz__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_Buzz__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_Buzz__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_Buzz__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_Buzz__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_Buzz__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_Buzz__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_Buzz__PS CYREG_PRT0_PS
#define Pin_Buzz__SHIFT 6u
#define Pin_Buzz__SLW CYREG_PRT0_SLW
...
/* RegPrescaler */
#define RegPrescaler_Sync_ctrl_reg__0__MASK 0x01u
#define RegPrescaler_Sync_ctrl_reg__0__POS 0
#define RegPrescaler_Sync_ctrl_reg__1__MASK 0x02u
#define RegPrescaler_Sync_ctrl_reg__1__POS 1
#define RegPrescaler_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB11_12_ACTL
#define RegPrescaler_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB11_12_CTL
#define RegPrescaler_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB11_12_CTL
#define RegPrescaler_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB11_12_CTL
#define RegPrescaler_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB11_12_CTL
#define RegPrescaler_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB11_12_MSK
#define RegPrescaler_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB11_12_MSK
#define RegPrescaler_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB11_12_MSK
#define RegPrescaler_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB11_12_MSK
#define RegPrescaler_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB11_ACTL
#define RegPrescaler_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB11_CTL
#define RegPrescaler_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB11_ST_CTL
#define RegPrescaler_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB11_CTL
#define RegPrescaler_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB11_ST_CTL
#define RegPrescaler_Sync_ctrl_reg__MASK 0x03u
#define RegPrescaler_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define RegPrescaler_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define RegPrescaler_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB11_MSK

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "MPS_W22_Prakt_4"
